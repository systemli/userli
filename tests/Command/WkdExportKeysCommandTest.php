...
class WkdExportKeysCommandTest extends TestCase
{
    /**
     * @var WkdExportKeysCommand
     */
    private $command;
    ...
    public function setUp(): void
    {
        ...
        $repository->method('findUsersWithWkdKey')->willReturn([$user]);
    ...
    public function testExecute(): void
    {
        ...
        self::assertStringContainsString('Exported 1 WKD keys to WKD directory', $output);
    }
}
