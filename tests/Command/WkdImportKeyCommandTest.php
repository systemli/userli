...
use App\Command\WkdImportKeyCommand;
use App\Entity\User;
...
class WkdImportKeyCommandTest extends TestCase
{
    /**
     * @var WkdImportKeyCommand
     */
    private $command;
    ...
    public function setUp(): void
    {
        ...
        $this->command = new WkdImportKeyCommand($manager, $openPGPWkdHandler);
    }
    ...
    public function testExecute(): void
    {
        ...
        self::assertStringContainsString('Imported WKD key for user alice@example.org', $output);
    }
