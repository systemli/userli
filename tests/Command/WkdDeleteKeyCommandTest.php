...
class WkdDeleteKeyCommandTest extends TestCase
{
    /**
     * @var WkdDeleteKeyCommand
     */
    private $command;
    ...
    public function testExecute(): void
    {
        ...
        self::assertStringContainsString('Deleted WKD key for user alice@example.org', $output);
    }
