...
class WkdHandlerTest extends TestCase
{
    ...
    {
        $this->wkdPath = $this->wkdDirectory.DIRECTORY_SEPARATOR.$this->domain.DIRECTORY_SEPARATOR.'hu'.DIRECTORY_SEPARATOR.$this->wkdHash; // TODO: Change the autogenerated stub
    }
