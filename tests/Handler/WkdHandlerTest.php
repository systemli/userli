...
class WkdHandlerTest extends TestCase
{
    ...
    public function testDeleteKey(): void
    {
        ...
        $manager->method('getRepository')->willReturn($repository);
        $manager->expects($this->once())->method('remove')->with($openPgpKey);
        $manager->expects($this->once())->method('flush');

        $handler = new WkdHandler($manager);
    ...
    {
        self::assertEquals('kei1q4tipxxu1yj79k9kfukdhfy631xe', WkdHandler::wkdHash('alice'));
    }
}
