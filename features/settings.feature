Feature: Settings
  ...
  Scenario: Settings form displays all configured fields
    ...
    And I should see "Application Domain"
    ...
    And I should see "Registration Enabled"
    And I should see "Default User Quota"
  ...
  Scenario: Admin can update settings successfully
    ...
    And I fill in "settings[user_quota_default]" with "2048"
    ...
    And the "settings[user_quota_default]" field should contain "2048"
