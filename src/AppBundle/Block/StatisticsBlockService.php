...
use AppBundle\Counter\VoucherCounter;
    ...
    public function execute(BlockContextInterface $blockContext, Response $response = null)
    {
        ...
        return $this->templating->renderResponse(
            ...
            array(
                ...
                'settings' => $settings,
                'users_since' => (null !== $usersSince = $this->manager->getRepository('AppBundle:User')->findUsersSince(
                        new \DateTime('-7 days')
                    )) ? count($usersSince) : 0,
                'users_count' => $this->userCounter->getCount(),
                'vouchers_count' => $vouchersCount = $this->voucherCounter->getCount(),
                'vouchers_redeemed' => (null !== $vouchersRedeemed = $this->manager->getRepository('AppBundle:Voucher')->findAllRedeemedVouchers()) ? count($vouchersRedeemed) : 0,
