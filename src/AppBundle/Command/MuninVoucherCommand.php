...
class MuninVoucherCommand extends ContainerAwareCommand
{
    ...
    {
        return $this->getContainer()->get('doctrine')->getRepository('AppBundle:Voucher');
    }

    /**
     * @return \AppBundle\Counter\VoucherCounter
     */
    private function getVoucherCounter()
    {
        return $this->getContainer()->get('AppBundle\Counter\VoucherCounter');
    }
}
