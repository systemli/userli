...
{
    /**
     * @Route("/{_locale}/user/twofactor", name="user_twofactor")
    ...
    /**
     * @Route("/{_locale}/user/twofactor_confirm", name="user_twofactor_confirm")
     * @param Request $request
     * @return Response
     * @throws Exception
     */
    ...
    /**
     * @Route("/{_locale}/user/twofactor_backup_codes", name="user_twofactor_backup_ack")
     * @param Request $request
     * @return Response
     * @throws Exception
     */
    ...
    /**
     * @Route("/{_locale}/user/twofactor_disable", name="user_twofactor_disable")
     * @param Request $request
     * @return Response
     * @throws Exception
     */
    ...
    /**
     * @Route("/{_locale}/user/twofactor/qrcode", name="user_twofactor_qrcode")
     * @param TotpAuthenticatorInterface $totpAuthenticator
     * @return Response
     * @throws Exception
     */
